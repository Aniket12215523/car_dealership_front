  ...
  <div className="hud-section speed-readout">
    ...
    <span className="hud-value">{currentCar.specs.topSpeed} km/h</span>
        ...
        <div className="stat-item">
          ...
          <span className="value">{currentCar.specs.topSpeed} </span>
        </div>
        <div className="stat-item">
          <span className="label">acceleration: </span>
          <span className="value">{currentCar.specs.acceleration} </span>
        </div>
        <div className="stat-item">
          <span className="label">Power:</span>
          <span className="value">{currentCar.specs.horsepower}</span>
        </div>
        <div className="stat-item">
          <span className="label">Engine: </span>
          <span className="value">{currentCar.specs.engine}</span>
        </div>
